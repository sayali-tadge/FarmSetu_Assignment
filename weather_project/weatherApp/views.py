...
from .serializers import YearlyWeatherDataSerializer , WeatherDataFilterSerializer
...
class WeatherDataFilterViewSet(viewsets.ReadOnlyModelViewSet):
    queryset = YearlyWeatherData.objects.all()
    serializer_class = WeatherDataFilterSerializer
